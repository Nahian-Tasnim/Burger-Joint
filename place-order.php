            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-action-add-shopping-cart"><?php echo $balance;?></i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
...
?>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="#" target="_blank">Group09</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Group09</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
